...
let
  ...
  symlinkLayerMeta = fromJSON (unsafeDiscardStringContext (readFile (runCommand "symlink-layer-meta.json"
    {
  ...
  buildOutput = {
    runtimeGraph = fromJSON (unsafeDiscardStringContext (readFile runtimeGraph));
